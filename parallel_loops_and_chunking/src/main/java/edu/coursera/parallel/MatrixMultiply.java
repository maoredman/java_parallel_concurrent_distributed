...
public final class MatrixMultiply {
    ...
    public static void parMatrixMultiply(final double[][] A, final double[][] B,
         ...
         */
        // NOTE: without chunking, may only achieve around x1.3 speedup because too many tasks are created
        // with chunking, achieves more than x2 speedup on my computer
